...
PROMPT_AUDIO="$REPO_ROOT/assets/default_prompt/prompt.wav"
PROMPT_TEXT_FILE="$REPO_ROOT/assets/default_prompt/prompt.txt"
PROMPT_TRACK_JSON="$REPO_ROOT/assets/default_prompt/prompt_track.json"
